...
class DB2
{
	...
	function DB2($argDB_HOST = 'localhost', $argDB_USER = 'tnoaunimewb9aenr', $argDB_PASSWORD = '2A28C5TLYTYFq1ZkkX1I', $argDB_NAME = 'tnoaunimewb9aenr-Test', $argDB_Language = 'utf8')
	{
