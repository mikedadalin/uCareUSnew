...
for ($page=1;$page<=$pageno;$page++) {
	...
	$rowno = $pageno*$drugno;
?>
<div style="width:1480px;"><center><?php echo $_SESSION['nOrgName_lwj'].' '.substr($qdate,0,4).' Year '.substr($qdate,4,2); ?> 月給藥紀錄單monthly drug record</center></div>
<table border="1" style="border-collapse:collapse; font-size:10pt;" width="1480">
  <tr id="backtr"  style="border:none;" height="20">
    <td class="title" width="60" style="border:none;">Bed number</td>
...
<table border="1" style="border-collapse:collapse; text-align:center;" width="1480">
  <tr class="title" height="30">
    <td width="30">起from</td>
    <td width="30">Until</td>
    <td width="200">藥名drug name (Dose)</td>
    <td width="62">Time</td>
    <?php
  ...
  <tr height="20">
    ...
    <td  class="title">白班day time shift</td>
    <?php echo drawmedcal_br('',''); ?>
  </tr>
  <tr height="20">
    <td  class="title"><font size="2">不良反應adverse reaction</font></td>
    <?php echo drawmedcal('',''); ?>
  </tr>
  <tr height="20">
    <td  class="title">小夜night time shift</td>
    <?php echo drawmedcal_br('',''); ?>
  </tr>
  <tr height="20">
    <td  class="title"><font size="2">不良反應adverse reaction</font></td>
  ...
  <tr height="20">
    <td  class="title">大夜graveyard shift</td>
    <?php echo drawmedcal_br('',''); ?>
  </tr>
  <tr height="20">
    <td  class="title"><font size="2">不良反應adverse reaction</font></td>
  ...
  <tr>
    <td colspan="3" rowspan="3">I/O狀況status</td>
    <td><font size="2">STOOL藥medication</font></td>
    <?php echo drawmedcal('',''); ?>
  </tr>	
  <tr>
    <td><font size="2">STOOL解便excrement</font></td>
    <?php echo drawmedcal('',''); ?>
  </tr>
  <tr>
    <td><font size="2">I/O</font></td>
    <?php echo drawmedcal('',''); ?>
  </tr>
</table>
<?php
	if ($pageno==$page) {
		echo '<p><font size="2">縮寫abbreviation：禁食fasting(nil per os) - NPO　拒絕refuse - Ref　外出out - Out　睡眠sleep - Slp　缺藥lack of medicine - A　不良反應adverse reaction - O/X　其他other - ＊ (Noted in Nursing recordsstate in nursing record)</font></p>';
	} else {
		echo '<p style="page-break-after: always;"><font size="2">縮寫abbreviation：禁食fasting(nil per os) - NPO　拒絕refuse - Ref　外出out - Out　睡眠 sleep- Slp　缺藥lack of medicine - A　不良反應adverse reaction - O/X　其他other - ＊ (Noted in Nursing recordsstate in nursing record)</font></p>';
	}
}
?>
</body>
