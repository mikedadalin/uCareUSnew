...
if (@$_GET['date']=='') {
	$sql = "SELECT * FROM `socialform21_1` WHERE `HospNo`='".mysql_escape_string($r['HospNo'])."' ORDER BY `date` DESC LIMIT 0,1";
} else {
	$sql = "SELECT * FROM `socialform21_1` WHERE `HospNo`='".mysql_escape_string($r['HospNo'])."' AND `date`='".mysql_escape_string($_GET['date'])."'";
}
$db1 = new DB;
$db1->query($sql);
$r1 = $db1->fetch_assoc();
...
<table width="800" style="broder:none;">
  <tr>
    <td><center><font size="3">萬芳醫院local hospital name<br />Rehabilitation department report(1)</font></center></td>
  </tr>
</table>
<table width="800" style="broder:none;">
  <tr>
...
<table width="800" style="broder:none;">
  <tr>
    <td colspan="2" style="line-height:28px;"><center><font size="3">Initial Note</font></center></td>
  </tr>
  <tr>
    <td colspan="2">
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; This <u>&nbsp;&nbsp;<?php echo $Q7; ?>&nbsp;&nbsp;</u> Years old <u>&nbsp;&nbsp;<?php echo $Q8 ?>&nbsp;&nbsp;</u> patient was a case of <div style="width:440px; display:inline-block; border-bottom:solid 1px;">&nbsp;<?php echo $Q9; ?>&nbsp;</div>.<br />
   Physical therapy programs started on <u>&nbsp;&nbsp;<?php echo $Q10; ?>&nbsp;&nbsp;</u>. Physical Examination was listed as Table 1. Major problems were listed as Table 2. Physical Therapy program included items in Table 3.
    </td>
  </tr>
  <tr>
...
side: heel to shin <?php echo $Q22a; ?> times/10sec</center></td>
    ...
    <span style="line-height:28px; font-size:10pt;">PS 1: levels 1. total assis (0%)  2. maximal assist (>3/4)   3. with moderate assist (1/2)  4. with minimal assist (1/4)<br />
  ...
  <tr>
    <td colspan="2">Tab 2</td>
  </tr>
  <tr>
    <td colspan="2">
    <table class="drawformborder" style="width:408px; margin-left:14px; font-size:9pt;" cellpadding="0" cellspacing="0">
      <tr>
        <td width="20"><center><?php if ($r1['Q26_1']==1) { echo '&#10003;'; } ?></center></td>
        <td width="180">Pain</td>
        <td width="20"><center><?php if ($r1['Q26_5']==1) { echo '&#10003;'; } ?></center></td>
        <td width="180">Poor functional status</td>
      </tr>
      <tr>
        <td width="20"><center><?php if ($r1['Q26_2']==1) { echo '&#10003;'; } ?></center></td>
        <td width="180">Decreased joint range of<br />motion</td>
        <td width="20"><center><?php if ($r1['Q26_6']==1) { echo '&#10003;'; } ?></center></td>
        <td width="180">Incorrect gait / posture</td>
      </tr>
      <tr>
        <td width="20"><center><?php if ($r1['Q26_3']==1) { echo '&#10003;'; } ?></center></td>
        <td width="180">Decreased muscle strength</td>
        <td width="20"><center><?php if ($r1['Q26_7']==1) { echo '&#10003;'; } ?></center></td>
        <td width="180">Poor balance ability</td>
      </tr>
      <tr>
        <td width="20"><center><?php if ($r1['Q26_4']==1) { echo '&#10003;'; } ?></center></td>
        <td width="180">Poor endurance</td>
        <td width="20"><center><?php if ($r1['Q26_8']==1) { echo '&#10003;'; } ?></center></td>
        <td width="180">Deconditioning</td>
      </tr>
    </table>
    </td>
  </tr>
  <tr>
    <td colspan="2">Tab 3</td>
  </tr>
  <tr>
    <td colspan="2">
    <table class="drawformborder" style="width:408px; margin-left:14px; font-size:9pt;" cellpadding="0" cellspacing="0">
  ...
  <tr height="60">
    <td colspan="2" valign="top">Short Term Goals:<br /><?php echo str_replace("\'","'",$Q28); ?></td>
  </tr>
  <tr height="60">
    <td colspan="2" valign="top">Long Term Goals:<br /><?php echo str_replace("\'","'",$Q29); ?></td>
  </tr>
  <tr height="60">
  ...
  <tr height="70">
    <td align="left">臺北醫學大學‧市立萬芳醫院local hospital name 96-12-B</td>
    <td align="right">F4200077(B)</td>
  </tr>
</table>
  </td>
</tr>
