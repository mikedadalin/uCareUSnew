...
if (isset($_POST['submit'])) {
	...
	echo "<script>window.onbeforeunload=null;window.location.href='index.php?mod=socialwork&func=formview&id=10b&pid=".$_GET['pid']."'</script>";
}
...
<form  method="post" onSubmit="return checkForm();" action="index.php?mod=socialwork&func=formview&id=10b_4&pid=<?php echo $_GET['pid']; ?>&Qreply=<?php echo $_GET['Qreply']; ?>">
	<table width="100%" border="0">
		<tr>
			<td colspan="2"><div align="right"><form><input type="button" value="View plan" id="viewform" /></form></div></td>
		</tr>
		<tr>
