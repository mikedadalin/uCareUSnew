...
<form action="index.php?func=database&action=save" align="left">
<input type="button" id="newrecord" value="New notification" onclick="openVerificationForm('#dialog-form'); filloldrecord();" style="height:30px"/></form>
...
<table style="width:100%;" id="recordlist">
  ...
  <tbody>
	...
	echo '
  <tr>
    <td width="6%"><center><a href="index.php?mod=nutrition&func=form31edit&pid='.mysql_escape_string($_GET['pid']).'&date='.$r2['date'].'&time='.$r2['time'].'"><img src="Images/edit_icon.png" width="20" border="0"></a></center></td>
	...
	if ($r2['Qfiller']==$_SESSION['ncareID_lwj']) {
		echo '<center><a href="index.php?mod=nutrition&func=form31delete&pid='.mysql_escape_string($_GET['pid']).'&date='.$r2['date'].'&time='.$r2['time'].'"><img src="Images/delete2.png" border="0"></a></center>';
	} else { echo '&nbsp;'; }
	echo '</center></td>
  </tr>
	'."\n";
