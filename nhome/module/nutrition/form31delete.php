...
if (isset($_POST['submit_delete'])) {
	...
	echo '<script>window.location.href=\'index.php?mod=nutrition&func=formview&pid='.getPID($_POST['HospNo']).'&id=31\';</script>';
}
?>
<div class="content-query">
<table align="center">
  <tr>
    <?php if (@$_GET['id']!=NULL) { echo '<td align="center" bgcolor="#ffffff"><a href="index.php?mod=nutrition&func=formview&pid='.mysql_escape_string($_GET['pid']).'"><img src="Images/back_button.png"></a></td>'; } ?>
...
<table border="0" style="text-align:left; padding-left:20px;">
  <tr>
    ...
    <form action="index.php?mod=nutrition&func=form31delete" method="post">
