...
if($_POST['Date1'] !="____/__/__" && $_POST['Date2'] !="____/__/__"){
	if(isset($_POST['Search'])){
		$_SESSION['Date1'] = str_replace("/","",$_POST['Date1']);
		$_SESSION['Date2'] = str_replace("/","",$_POST['Date2']);
		$strSQL = " AND `date`>='".$_SESSION['Date1']."' AND `date`<='".$_SESSION['Date2']."'";
	}
}
...
?>
<div id="dialog-form" title="Vitalsigns" class="dialog-form"> 
	<form id="base">
...
<?php
$db = new DB;
$db->query("SELECT `patientID`,`height`,`Birth` FROM `patient` WHERE `patientID`='".mysql_escape_string($_GET['pid'])."' ORDER BY `patientID` ASC");
...
<table align="center" style="width:100%;" cellpadding="7">
<tr>
...
?>
<div style="background-color: rgba(255,255,255,0.8); border-radius: 10px; padding:10px 0px 30px 0px; margin-bottom: 20px; width:100%; overflow:hidden">
				...
				<tr>
					<td valign="top" colspan="2" align="center">
						<div id="tab1">
							...
							<table cellpadding="7px" style="font-size:10pt; width:100%; text-align:center;">
								<tr bgcolor="#f7bbc3" style="color:#ffffff; text-transform: capitalize;" class="title">
									<td>Time</td>
									<td>Temperature</td>
									<td>Heart Beat</td>
									<td>Respiration</td>
								...
								if ($db2->num_rows()>0) {
									for ($i=0;$i<$db2->num_rows();$i++) {
										...
										<td align="left" ><span '.vsRange('vs83105',$valueof_83105).'>'.$valueof_83105.'</span> <font size="2" color="#999999">&ordm;F</font></td>
										<td align="left" ><span '.vsRange('vs88674',$valueof_88674).'>'.$valueof_88674.'</span> <font size="2" color="#999999">times/min.</font></td>
										<td align="left" ><span '.vsRange('vs92791',$valueof_92791).'>'.$valueof_92791.'</span> <font size="2" color="#999999">times/min.</font></td>
										<td align="left" ><span '.vsRange('vs84806',$valueof_84806).'>'.$valueof_84806.'</span> / <span '.vsRange('vs84624',$valueof_84624).'>'.$valueof_84624.'</span> <font size="2" color="#999999">mmHg</font></td>
										<td align="left" ><span '.vsRange('vs27102',$valueof_27102).'>'.$valueof_27102.'</span> <font size="2" color="#999999">%</font></td>
										<td align="left" ><span '.vsRange('vs460337',$valueof_460337).'>'.$valueof_460337.'</span> <font size="2" color="#999999">Score</font></td>
										<td align="left" ><span '.vsRange('vs147439',$valueof_147439).'>'.$valueof_147439.'</span> <font size="2" color="#999999">mg/dL</font></td>
										<td align="left" ><span '.vsRange('vs150755',$valueof_150775).'>'.$valueof_150755.'</span> <font size="2" color="#999999">mg/dL</font></td>
										<td align="left" ><span '.vsRange('vs391060',$valueof_391060).'>'.$valueof_391060.'</span> <font size="2" color="#999999">&ordm;F</font></td>
										<td align="left" ><span '.vsRange('vs188334',$valueof_188334).'>'.$valueof_188334.'</span> <font size="2" color="#999999">lbs</font></td>
										<td align="left" >'.checkusername($Qfiller).'</td>
										</tr>
										'."\n";
									}
								} else {
						...
						<div id="tab2" style="display:none;">
							...
							<div style="width:99%; padding:20px 0px;"><div id="bpchart" style="width:720px;height:300px; margin:40px 0px;"></div></div>
							<table cellpadding="6px" style="width:100%;">
								<tr bgcolor="#f7bbc3" style="color:#000000;">
									<td>Name</td>
									<td>Type</td>
									<td>Value</td>
									<td>Measure Time</td>
	...
	<?
	if (count($arr8462)>0 || count($arr8480)>0) {
		?>
		...
		$(function () {
			$.plot($("#bpchart"), [
				...
				],
				{
					...
					yaxis: { panRange: [-10, 10], 'color': '#000' },
	...
	<?
		...
		?><script>$(function() { $("#bpchart").css("background", "#eee").css("border", "3px solid #000").css("padding", "20px").html("No information"); }); </script><?
	}
	?>
	</div>
	<div id="tab3" style="display:none;">
		...
		<div style="width:99%; padding:20px 0px;"><div id="oxichart" style="width:720px;height:300px; margin:40px 0px;"></div></div>
		<table cellpadding="6px" style="width:100%;">
	...
	<div id="tab4" style="display:none;">
		...
		<div style="width:99%; padding:20px 0px;"><div id="bgchart" style="width:720px; height:300px; margin:40px 0px;"></div></div>
		<table cellpadding="6px" style="width:100%;">
			<tr bgcolor="#f7bbc3" style="color:#ffffff;">
				<td>Name</td>
				<td>Type</td>
	...
	<div id="tab5" style="display:none;">
		...
		<div style="width:99%; padding:20px 0px;"><div id="tempchart" style="width:720px;height:300px; margin:40px 0px;"></div></div>
		<table cellpadding="6px" style="width:100%;">
			<tr bgcolor="#f7bbc3" style="color:#ffffff;">
				<td>Name</td>
				<td>Type</td>
	...
	<div id="tab6" style="display:none;">
		...
		<div style="width:99%; padding:20px 0px;"><div id="respchart" style="width:720px;height:300px; margin:40px 0px;"></div></div>
		<table cellpadding="6px" style="width:100%;">
			<tr bgcolor="#f7bbc3" style="color:#ffffff;">
				<td>Name</td>
				<td>Type</td>
	...
	<div id="tab7" style="display:none;">
		...
		<div style="width:99%; padding:20px 0px;"><div id="painchart" style="width:720px;height:300px; margin:40px 0px;"></div></div>
		<table cellpadding="6px" style="width:100%;">
			<tr bgcolor="#f7bbc3" style="color:#ffffff;">
				<td>Name</td>
				<td>Type</td>
	...
	<div id="tab8" style="display:none;">
		...
		<div style="width:99%; padding:20px 0px;"><div id="bweightchart" style="width:720px;height:300px; margin:40px 0px;"></div></div>
		<table cellpadding="6px" style="width:100%;">
			<tr bgcolor="#f7bbc3" style="color:#ffffff;">
				<td>Name</td>
				<td>Type</td>
