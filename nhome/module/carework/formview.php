...
$arrNoSelDate = array("1","1_1a","1_2a","2","2_1a","3","3_1","3_2","4","4_1","5","5_1","5_2","6","6_1","11b","7","7_1","7_2","7_3","8","9","12","12_1","13");
$arrNoPrint = array("5","7","7_1","12_1","12");
$arrNoQueryCol = array("1","1_1a","1_2a","2","2_1a","3","3_1","3_2","4","4_1","8");  /*不需要居民資料*/
?>
...
<table align="center" style=" width:100%; font-size:10pt; margin: 0px 0px;">
  <tr id="backtr"  style="border:none; height:28px;" >
    <?php
	if (@$_GET['id']!=NULL) {
		echo '<td class="backbtnn" align="center" width="40" id="backbtn"  style="border:none;" rowspan="3"><a href="index.php?mod=carework&func=formview&pid='.mysql_escape_string($_GET['pid']).'">'.$word_Back.'</a></td>';
	}else{
		echo '<td class="backbtnn" align="center" width="40" id="backbtn"  style="border:none;" rowspan="3"><a href="index.php?func=careworklist" style="font-size:14px;">Resident List</a></td>';
	}
	?>
	<td class="title" width="80" style="border-top-left-radius:10px; background-color:#EECB35;"><?php echo $word_Bed; ?></td>
    <td width="60" style="border:none; padding-left: 10px;"><?php echo $bedID; ?></td>
    ...
    <td width="70" style="border:none; padding-left: 10px;"><?php echo getHospNoDisplayByHospNo($HospNo); ?></td>
...
<table border="0" style="text-align:center; margin-bottom:40px; width:100%;" onclick="closeResidentCol();">
  <tr>
	...
	if (@$_GET['id']!=NULL) {
		if (!in_array(@$_GET['id'],$arrNoSelDate)) {
			...
			$db = new DB;
			$db->query("SELECT * FROM `".$tablename."` WHERE `HospNo`='".$HospNo."' ORDER BY `date` DESC");
			echo '<div id="tabs" style="width:964px;">'."\n";
