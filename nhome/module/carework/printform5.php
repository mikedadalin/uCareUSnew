...
?>
    ...
    <?php
	$db2 = new DB;
	$db2->query("SELECT * FROM `careform05` WHERE `HospNo`='".$HospNo."' AND `date`>='".str_replace("-","",$qdate).(strlen($loopstart)==1?"0":"").$loopstart."' AND `date`<='".str_replace("-","",$qdate).(strlen($loopend)==1?"0":"").$loopend."'");
