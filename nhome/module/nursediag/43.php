...
<h3>43# Nursing diagnosis - Noncompliance/Uncooperative</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","No insight of disease",$Q3,"multi"); ?>
    </div></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Refuse medication;Refuse treatment",$Q4,"multi"); ?></td>
  </tr>  
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Reduce resistance behavior;Willing to accept treatment",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Assess reason of noncompliance/uncooperative;Take a calm, consistent, acceptable approach, avoid criticize and receive the resident;Explain the purpose of receiving treatment;Clearly tell the resident the possible consequences of refusing the treatment;Develop behavioral contracts if necessary;Clearly state the nursing handover record to provide consistent and continuous care",$Q6,"multi"); ?>
   </td>
  </tr>
</table>
