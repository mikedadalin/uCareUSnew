...
<h3>46# Nursing diagnosis -Violence (other-directed)</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Emotional pulses are not able to relieve (anger reaction);Poor self-control;Self-consciousness threatened;Delusional thinking and hallucinations",$Q3,"multi"); ?>
    </div></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q4","When there are signs of violence, request increased and low tolerance;Anxiety status with hostile eye contact, shouting abusing or verbal threatening.;Damage the items in the enviroment, such as smashing, breaking thing or kicking the door",$Q4,"multi"); ?>   
    </td>
  </tr>  
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Reduce the number of violent behavior;Resident does not harm others;Emotions can be handled in the correct manner and without verbal threatening;Resident can apply positive methods to relieve the emotions",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care plan</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Talks: understand the resident's needs and feelings, and mitigate their anxiety and excitement;Guide the resident to think of other solution to solve the problem;Provide protection room, giving emotional venting;Maintain the environment;Move away dangerous items in the enviroment such as chairs;Evacuate other resident from the location;Avoid contact the raging resident alone;Note safety distance (2-3 feet);Avoid touching the raging resident. (May be mistaken as assaulting);Contact the physician and apply medication by order;Restraint, isolation care (visits once every 15 minutes and fill out observation record)",$Q6,"multi"); ?>
   </td>
  </tr>
</table>
