...
<h3>25# Nursing diagnosis -Potentially hazardous infections: indwelling urine catheter </h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Indwelling catheter;Lack of knowledge;Fails to comply",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Able to speak out precautions to prevent infection, at least<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"6\" value=\"".$Q5a."\">matters/items;No urinary tract infection during the catheter indwelled",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Establish communication with resident and the family regarding care issues, and  discuss / explain the contents of care plan and precautions to prevent infection;Monitor and record changes in vital signs, notify the physician if abnormal;Perform Perineum cleansing at least twice a day, and maintain clean and dry;Observe and record the amount of urine, color, sediment and note whether there is swelling or seepage of the bladder of urine, notify the physician if abnormal;Maintain the position of urine bag to be below the bladder but no contacting ground;Maintain pipeline patency and closed, properly secured to avoid distortion, involve;Emptying urine bag at least once per shift, at any time the urine should be emptied if more than 1000㏄;If no particular restriction, minimum daily intake water more than 2000CC to promote urination, also can absorb some of the drinks which are acidic or rich in vitamin C such as cranberry juice;Observe whether the symptoms of urinary tract infection, notify the physician if abnormal;Periodically replace of the catheter according to medical advice",$Q6,"multi"); ?></td>
  </tr>
