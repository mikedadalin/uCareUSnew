...
<h3>19# Nursing diagnosis - Self-care deficit-food intake/Self-feeding</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q4","Can not send food from the container to mouth;Unable to cut/chew food;Nasogastric tube feeding;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Perform satisfying dieting pattern with assistance;Maintain appropriate body weight;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Dining assistance;Wear on bibs before meal and place the dishes properly;Chop the food for eatting convenience;Assist to load the foods onto the spoon to facilitate eating;Provide appropriate dining environment of the time, do not rush;Apply praise and encouragement when having meal;Note dine circumstances, food intake, and keep records;Wash hand before/after meals and perform oral hygiene after meals;Staff assist feeding if fully dependent;Other(s):<input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"60\" value=\"".$Q6a."\">",$Q6,"multi"); ?></td>
  </tr>
