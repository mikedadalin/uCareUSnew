...
<h3>42# Nursing diagnosis - Self-directed violence-Mild</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q4","Suicidal thoughts but no plan;Risk of taking action for suicide still low;Have insight for current problem",$Q4,"multi"); ?></td>
  </tr>  
  <tr>
  ...
  <tr>
    ...
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Observe the resident every 30 minutes;Maintain a safe environment, remove all dangerous materials;Irregular security check;Utilize individual conversation to express care, encouragement and assist in solving the problem (use non self-harming method to release the emotion pulse);Arrange activities to divert attention;Observe behavior and language to pre-detect signs of suicide ",$Q6,"multi"); ?>
   </td>
  </tr>
</table>
