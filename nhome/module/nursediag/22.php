...
<h3>22# Nursing diagnosis - Anxious/New residents adaptation problem</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Self-concept threatened;Lose of self-values;Loss of status and prestige;Unable to get other people's understanding;Lose meaningful supporters;Environmental changes;Caused by diseases;Other(s):<input type=\"text\" name=\"Q3a\" id=\"Q3a\" size=\"60\" value=\"".$Q3a."\">",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3">
	<h3>   Physiologically</h3>
	<?php echo draw_checkbox("Q4a","Xerostomia;Insomnia;Sweating;Palpitations;Tone change;Paresthesia;Other(s):<input type=\"text\" name=\"Q4c\" id=\"Q4c\" size=\"60\" value=\"".$Q4c."\">",$Q4a,"multi"); ?>
    <h3>    Psychologically</h3>
	<?php echo draw_checkbox("Q4b","Neuroticism;Disquiet;Lack of confidence;Out of control;Other(s):<input type=\"text\" name=\"Q4d\" id=\"Q4d\" size=\"60\" value=\"".$Q4d."\">",$Q4b,"multi"); ?>
    </td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Be familiar with the surrounding environment and workers, residents;Able to say the anxiety been improved;Maintain interaction of support system;Effective response measures;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Detailed environment, relevant personnel introduction, repeat if necessary;Assess the cause of anxiety;Support and enhance comfort;Increase visitation and companionship;Express empathy;Give reassurance;Avoid asking residents to make hard decision;Encourage resident to speak out their feeling;Speak slow and calm;Respect the resident and avoid criticizing or being judgemental;Support their adjustment mechanism, avoid confrontation with residents directly;Before performing medical or nursing treatment, explain and answer proble first;Resident teach relaxing methods;Respect residents to retain their religious beliefs and meaningful items;Other(s):<input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"60\" value=\"".$Q6a."\">",$Q6,"multi"); ?></td>
  </tr>
