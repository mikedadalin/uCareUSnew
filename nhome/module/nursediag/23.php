...
<h3>23# Nursing diagnosis -Protective restraint</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Cognitive disorders(Restless, orderless type consciousness);Fall prevention, such as fall under chairs;Self-injury, assault, extubation;Cooperation with medical treatment such as traction, rehabilitation exercise;Caused by disease(s): such as akathisia, Parkinson's disease;Inability to support;Other(s):<input type=\"text\" name=\"Q3a\" id=\"Q3a\" size=\"60\">",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Have history of injury by falling;Emotional instability, harm themselves or others;Unable to meet medical treatment;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Prevent the resident from falling and injury;Prevent resident from self-injury or assaulting others;Resident with restraint, keep skin integrity, normal circulation;Preven contractures;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Request for physician to assess when applying restraint. Also explain to the family and sign agreement.;Request nurse to assess the resident's consciousness in every shift;Q2H assess residents constraint parts blood circulation and skin integrity;Q2H to loosen restraints region 5 to 10 minutes;When finishing a short-term restraint such as preventing fall under chair or dinning, need to accompany;Other(s):<input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"60\" value=\"".$Q6a."\">",$Q6,"multi"); ?></td>
  </tr>
</table>
