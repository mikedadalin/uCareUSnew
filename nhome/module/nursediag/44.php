...
<h3>44# Nursing diagnosis -Confusion/orderless-acute</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Alcoholic delirium;Psychiatric symptoms (hallucinations or delusions);Alzheimer's disease",$Q3,"multi"); ?>
    </div></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Sudden changes/disorders of the degree of consciousness;Cognitive changes (disorientation, memory, attention);Day/Night reversed;Hyperactivity;Agitation;Unable to follow instructions;Perception changed(Hallucinations, delusions);Emotional changes",$Q4,"multi"); ?></td>
  </tr>  
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Resident no self-harm or harming others;Sleep patterns return to normal state;Able to identify the real and the unreal,Can self-care daily life before discharge",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Close observation of acute confusion orderless presented signs and symptoms;3 shifts to monitor the patient's state of consciousness, disorientation, feeling perception, sleep patterns and mental condition;Maintain a safe environment. If necessary apply protective isolation or restraint;Reduce bedfast in day time;Apply a safe and obvious device condition. Hang the sign on obvious location to inform the resident current time and location;Try to furnish at fix location;Timely provide the resident method to know current people, time, location such as: staff self-introduce;Mark the name tag of resident on the bed;Encourage resident to watch TV and discuss current events ;Depends on the resident's condition to apply complete assistance or semi-assist method to complete self-care (cleaning, bathing, modification ...);Observe resident's dieting pattern and maintain proper nutrition",$Q6,"multi"); ?>
   </td>
  </tr>
</table>
