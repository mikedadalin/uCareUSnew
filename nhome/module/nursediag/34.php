...
<h3>34# Nursing diagnosis - Fear</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3"," The body structure change or function lost;Unfamiliar environment and people;Terminal illness;Lack of knowledge;Pain;Surgery;Past negative experience;The threat of death;Other(s):<input type='text' name='Q3a' id='Q3a' size='30' value='".$Q3a."' />",$Q3,"multi"); ?>
    </div></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Resident cholesterol value;Sweat;Pulse, respiration, blood pressure increase;Multiple doubt;Trembling voice or tone change;Other(s):<input type='text' name='Q4a' id='Q4a' size='30' value='".$Q4a."' />",$Q4,"multi"); ?></td>
  </tr>  
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Able to speak out the reason that cause fear;Able to actively participate in the activities;Maintain interaction of support system;Muscle relaxation method can be performed properly;Other(s):<input type='text' name='Q5a' id='Q5a' size='30' value='".$Q5a."' />",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Correct record inducements, reduce or eliminate contributing factors;Guide the resident to express the reason that cause fear;Assist residents to solve the problem and seek resources",$Q6,"multi"); ?>
    <?php echo draw_checkbox("Q7","Strengthen teaching the method to control",$Q7,"multi"); ?>
    <div style="margin-left:36px;"><?php echo draw_checkbox("Q7a","Give related information of treatment, examination, before and after surgery;Disease general health education",$Q7a,"multi"); ?></div>
    <?php echo draw_checkbox("Q8","Teach methods to improve comfort or relaxation",$Q8,"multi"); ?>
    <div style="margin-left:36px;"><?php echo draw_option("Q8a","Deep breathing;Reading;Listen to music;Use Mnemonics;Hot baths","l","multi",$Q8a,false,5);?></div>
    <?php echo draw_checkbox("Q9","Other(s):<input type='text' name='Q9a' id='Q9a' size='30' value='".$Q9a."' />",$Q9,"multi"); ?>
   </td>
  </tr>
</table>
