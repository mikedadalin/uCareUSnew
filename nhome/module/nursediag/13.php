...
<h3>13# Nursing diagnosis - Serious hazardous respiratory infections</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Inflammation and immune response inhibited;Chronic diseases;Invasive treatment:<input type=\"text\" name=\"Q3a\" id=\"Q3a\" size=\"60\" value=\"".$Q3a."\">;Malnutrition;Bedridden;Other(s):<input type=\"text\" name=\"Q3b\" id=\"Q3b\" size=\"60\">",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Chronic cough;Increasing frequency of cough;Respiratory asthma;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","No respiratory infection occur;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Note temperature changes;Encourage residents to perform deep breathing and effective cough <input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"4\" value=\"".$Q6a."\"> Time(s)/Day(s);Encourage and assist residents to develop a daily exercise or ambulation plan;Assign caregivers /care workers to perform turing over and chest care <input type=\"text\" name=\"Q6b\" id=\"Q6b\" size=\"4\" value=\"".$Q6b."\"> Time(s)/Day(s);Teach the resident correct posture and speed of eating to avoid aspiration pneumonia;View the mouth after eating each meal and help clearing if necessary, make sure no food residue left in the mouth;Other(s):<input type=\"text\" name=\"Q6c\" id=\"Q6c\" size=\"60\" value=\"".$Q6c."\">",$Q6,"multi"); ?></td>
  </tr>
