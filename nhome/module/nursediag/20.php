...
<h3>20# Nursing diagnosis - Self-care deficit-Toileting</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Unable to endure daily activity;Reduce in physical endurance;Perceptual or cognitive impairment;Emotional disorders;Severe anxiety;Depression;Caused by disease;Other(s):<input type=\"text\" name=\"Q3a\" id=\"Q3a\" size=\"60\" value=\"".$Q3a."\">",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Unable to walk to the toilet or potty;Unable to sit on/ stand up from the toilet or potty;Unable to wear on/off clothes to toilet;Unable to  perform proper toilet hygiene;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Able to perform toileting with assistance;Maintain clean and comfortable after toileting;Other(s):<input type=\"text\" name=\"Q5c\" id=\"Q5c\" size=\"60\" value=\"".$Q5c."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3">
	<b>     Self toileting :</b>
	<?php echo draw_checkbox("Q6a","When toileting,  provide privacy. If incontinence occur, do not be criticizing;Place the call bell at reachable location when toileting;The establishment of urination, defecation plan;Every <input type=\"text\" name=\"Q6a1\" id=\"Q6a1\" size=\"4\" value=\"".$Q6a1."\"> hours, take the initiative to ask and to assist toileting (urine);Daily <input type=\"text\" name=\"Q6b1\" id=\"Q6b1\" size=\"4\" value=\"".$Q6b1."\"> time(s), take initiative to ask and to assist toileting(defecate)",$Q6a,"multi"); ?>
    <b>     Use diaper :</b>
	<?php echo draw_checkbox("Q6b","After each change of diaper, wipe with wet towel to dilute attached urine concentration;After each defecation, rinse hips for more comfort;Assist resident arranging clothes, to ensure clean, confort and neat;Other(s):<input type=\"text\" name=\"Q6c\" id=\"Q6c\" size=\"60\" value=\"".$Q6c."\">",$Q6b,"multi"); ?>
    </td>
  </tr>
