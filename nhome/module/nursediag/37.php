...
<h3>37# Nursing diagnosis - Verbal communication impaired</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Tracheostomy;Cerebrovascular issue;Brain damage;Increased intracranial pressure;Tumor;Aphasia;Neurological damage;Slurred speech or stuttering;Dialect or foreign language",$Q3,"multi"); ?>
    </div></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Unable to speak;Dysphonia;Unable to speak in complete sentences;Unable to describe with appropriate word/term;Stuttering, vague language",$Q4,"multi"); ?></td>
  </tr>  
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Effective communication;Enhance self-expression",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Assess the extent and patterns of resident verbal communication barriers ;Arrange quiet and comfortable environment;Use a variety of ways to communicate, such as drawing, writing, gesture, wink, nod, or other body language;In short sentences, apply yes/no question to communicate with resident slowly and clearly;When performing nursing activities, apply understandable language or nonverbal way of expressing the pre-conduct activity or acitiviy being performed;Encourage the resident to express feeling and give enough time to answer and respond;Place call bell at reachable location of resident",$Q6,"multi"); ?>
   </td>
  </tr>
</table>
