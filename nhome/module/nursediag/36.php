...
<h3>36# Nursing diagnosis - Cognitive dysfunction</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Caused by disease;Peripheral stimulation changes",$Q3,"multi"); ?>
    </div></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Cognitive dissonance;Missing memory ;Alertness change",$Q4,"multi"); ?></td>
  </tr>  
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Strengthen resident cognitive function in this facility",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Assess the resident's emotion/cognition function, complete SPMSQ scale",$Q6,"multi"); ?>
    <?php echo draw_checkbox("Q7","Establish a consistent daily routines and environment",$Q7,"multi"); ?>
    <div style="margin-left:36px;"><?php echo draw_checkbox("Q8","Place calender at obvious location;Place the meaningful items/photos at obvious location;TV, radio;Make daily activities schedule;Avoid changing decoration and interior layout;Provide resident proper rest",$Q8,"multi"); ?></div>
    <?php echo draw_checkbox("Q9","Provide appropriate audiovisual aids and communication;Apply gradually for changes that are related to the resident;Provide clear message and only provide one message per time;Avoid providing excessive stimulus when residents is orderless/ confused;Provide a safe and familiar environment, for residents to walk;Contact physician when needed and apply medication according to the medical advice;Other(s):<input type='text' name='Q9a' id='Q9a' size='30' value='".$Q9a."' />",$Q9,"multi"); ?>
