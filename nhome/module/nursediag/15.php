...
<h3>15# Nursing diagnosis - Serious hazardous-fall</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Cognitive disorders;Dementia;Other(s):<input type=\"text\" name=\"Q3a\" id=\"Q3a\" size=\"60\" value=\"".$Q3a."\">",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Show disobedient behavior;Indirect information to know the disobedient behavior occured;Not able to feel the threat/danger of falling;Emotional restlessness;Loss of orientation;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","No fall incident occur;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Teaching procedures and methods of progressive ambulation;Bed rail(s) stability check in every shift;Arrange a safe environment;Place the commonly used object and emergency bell in accessible location;Remove channel obstructions and keep ground dry;Inform residents and their families and request for accompanying while getting out of the bed;Maintain appropriate light intensity;Select the appropriate size and non-slip shoes;Teach and train to use the walker;Teach to use bed rails. If necessary, use restraint band to prevent falls;Explain and fill restraint consent/agreement to the families;Other(s):<input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"60\" value=\"".$Q6a."\">",$Q6,"multi"); ?></td>
  </tr>
