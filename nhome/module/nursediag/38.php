...
<h3>38# Nursing diagnosis - Anticipative/existing grieving</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Changes in body system functions, the loss related to existing or potential;Relate with body image changing;Relate to loss of control of daily activities;Relate to loss of meaningful person or things",$Q3,"multi"); ?>
    </div></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Actual or percieve loss of mate;Depression;Fear;Feeling inability worthlessness;Grief;Deny;Cry/weep;Apathy behavior;Change of diet or sleep patterns;Disappointed, angry",$Q4,"multi"); ?></td>
  </tr>  
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Residents can speak out the grief emotion;Resident can share the grief with meaningful people;Resident can speak out future plan",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Support the resident when in grief emotion;Promote the establishment of a trust relationship;Arrange safe and private enviroment;By physiological care to maintain comfortable;Arrange a time for resident to discuss their feelings to others;Provide the opportunity to express grief;Promote family cohesion and support;Consult psychiatrist if needed",$Q6,"multi"); ?>
   </td>
  </tr>
</table>
