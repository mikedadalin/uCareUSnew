...
<h3>16# Nursing diagnosis - Sensory and perceptual changes-vision & Auditory, sense of direction</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Caused by disease;Environmental factors;Medical environment: bedfast, restricted activity or restraint;Social environment: aging, hospitalization, chronic disease;Other(s):<input type=\"text\" name=\"Q3a\" id=\"Q3a\" size=\"60\" value=\"".$Q3a."\">",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Lost of orientation to people, time, location;Sensitiity of perception changed;Lack of concentration;Anxiety, irritability;Incoordination;Visual, auditory distortions;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Improve the orientation of people, location and time;Able to identify environmental events and sound correctly;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Improve orientation sense;Monitor resident cognitive function (MMSE/SPMSQ/BIMS);Establish a consistent daily routines and environment;Place calendar or clock at striking location;Place resident's meaningful item(s) or photo(s) at prominent places;TV, radio;Improve auditory or visual perception error;Provide appropriate visual aids and manner of communication;Adopt a gradual approach when changing the environment;Provide a clear message, and only one message at a time;Avoid excessive stimulation when resident is orderless/confused;According to the medical advice to apply medication such as:<input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"60\" value=\"".$Q6a."\">;Provide resident safe and familiar environment;Apply bed rails and reduce the height of the bed;Wear non-slipping slippers;Proper light;Avoid frequent changes in interior layout, furnishings;Clarify misperceptions or misinterpretations on the environment to the resident;Encourage resident to speak their worry, fear or anxiety;Other(s):<input type=\"text\" name=\"Q6b\" id=\"Q6b\" size=\"60\" value=\"".$Q6b."\">",$Q6,"multi"); ?></td>
  </tr>
