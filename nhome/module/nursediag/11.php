...
<h3>11# Nursing diagnosis - Comfort status change-Itchy</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Caused by disease;Scabies;Rubella/Eczema;Mould;Liver disease;Diabetes;Kidney disease;Environment;Medications such as:<input type=\"text\" name=\"Q3a\" id=\"Q3a\" size=\"30\" value=\"".$Q3a."\">;Other(s):<input type=\"text\" name=\"Q3b\" id=\"Q3b\" size=\"60\">",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Pimple;Scratch;Rashes;Dry skin, scaling;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Alleviate the symptoms;Understand the causes of itching;Improve physical comfort;Prevent complications;Maintain the integrity of the skin;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Reduce or eliminate contributing factors;Maintain the skin to be clean and avoid over-drying;Avoid overheating bath, and take a bath every 2 days;Use a mild soap or a substitute. If necessary, bath with water only(no soap);After cleaning, apply vaseline or lotion to tap lightly;Imrpove level of comfort and prevent further damage;Teaches methods to reduce the itching-tap, massage, icing;Keep nails smooth, prevent scratching skin;Apply restraint on the resident, properly explain to the family and request for  signing the agreement;Contact the physician if needed, and apply medication according to the medical advice.;Other(s):<input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"60\" value=\"".$Q6a."\">",$Q6,"multi"); ?></td>
  </tr>
