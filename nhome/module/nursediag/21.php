...
<h3>21# Nursing diagnosis -Sleep patterns disorder</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Respiratory and circulatory system diseases;Metabolic dysfunction;Stationary or restraint;Pain;Anxious;Environmental changes;Behavior pattern change before bedtime;Lack of exercise;Bedridden;Other(s):<input type=\"text\" name=\"Q3a\" id=\"Q3a\" size=\"60\" value=\"".$Q3a."\">",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Hard falling asleep or often interrupted;Mental fatigue;Dozing;Yawn repeatedly;Lack of concentration;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Increase the time of quality sleep or uninterrupted sleep time;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Reduce or exclude the factor that interfere with sleeping;Avoid unnecessary noise;Centralize the caregiving activity to avoid sleeping interruption;Provide proper lighting in day/night time;Restrict water intake at night and empty the bladder before bedtime;Appropriately adjust or increase activity levels during the daytime;Visit once per 2 hours in day shift to reduce daytime sleeping;Arrange the resident to talk to other, in order to maintain sobriety;Improve comfort to pormote sleeping quality;Massage;Soft music;Appropriate room temperature and blankets;Apply medication according to status: <input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"20\" value=\"".$Q6a."\"> and note the side effects.;Other(s):<input type=\"text\" name=\"Q6b\" id=\"Q6b\" size=\"60\" value=\"".$Q6b."\">",$Q6,"multi"); ?></td>
  </tr>
