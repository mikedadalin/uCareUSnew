...
<h3>35# Nursing diagnosis - Powerlessness</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Ineffective communication skills;Unable to engage in activities of daily living;Progressive or chronic diseases;Loss of control power;Environmental changes;Social isolation;Not involved in major decisions",$Q3,"multi"); ?>
    </div></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Expressed inability to control the current situation;Refusal or unwillingness to participate in decision making;Aggressive or violent behavior;Apathy",$Q4,"multi"); ?></td>
  </tr>  
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Able to express the feeling of powerless;Able to make decision by oneself",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Providing information associated with the care, give detailed explanation and let the resident have the time to prepare and participate in planning;Arrange specific personnel to provide continuity of care;Guide and listen to the case and inner feeling and interest;Empower the resident for daily activity and decision making;Provide effective support system such as religion, family or similar situation;Assist the resident establishing realistic goals and expectations",$Q6,"multi"); ?>
   </td>
  </tr>
</table>
