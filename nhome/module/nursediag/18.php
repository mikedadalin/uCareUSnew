...
<h3>18# Nursing diagnosis - Self-care deficit-dressing and accessory</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q4","Ability to dress/undress clothe impaired;Impaired ability to pick up or place clothes;Impaired ability to fasten clothing;Unable to maintain satisfying appearance;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Be able to dress up with the assistance of caregivers/ care workers;Clean appearance;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Before bathing, residents can choose clothes;After morning care, give a comb to help make it look neat;Moderate or mild assistance depending resident, encourage and assist to perform dressing up (help to become independent);After the completion of each dressing up, verbal praise, strengthen the behavior;Other(s):<input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"60\" value=\"".$Q6a."\">",$Q6,"multi"); ?></td>
  </tr>
