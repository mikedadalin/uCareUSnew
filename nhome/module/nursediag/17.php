...
<h3>17# Nursing diagnosis - Self-care deficit-bathing and hygiene</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q4","Unable to get out of bed independently;Unable to clean body or certain body location;Other(s):<input type=\"text\" name=\"Q4a\" id=\"Q4a\" size=\"60\" value=\"".$Q4a."\">",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Able to perform bathing and hygiene work with the assistance of caregivers/ care workers;Without unpleasant odor;Maintain physical comfort and cleaning;Other(s):<input type=\"text\" name=\"Q5a\" id=\"Q5a\" size=\"60\" value=\"".$Q5a."\">",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","When bathing, provide concealment, safety of the environment, such as shower curtains...etc.;Take a bath and change of clothes every day, or to take a sponge bath on the bed;Place towels, toilet paper at accessible place;Upon completion of cleaning work, giving residents verbal praise;Other(s):<input type=\"text\" name=\"Q6a\" id=\"Q6a\" size=\"60\" value=\"".$Q6a."\">",$Q6,"multi"); ?></td>
  </tr>
