...
<h3>27# Nursing diagnosis -Comfort status change-Pain </h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Caused by disease;Cancer;Gout;Arthritis;Muscle soreness;Trauma;Visceral disease;Environment;Medication;Psychological factors;Vascular disease;Inflammation;The inappropriate posture;Improper activities damage;Formation of stress points",$Q3,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Personal complained of pain;Autonomic response of pain;Increased blood pressure;Fast pulse;Increased respiration;Clammy skin;Mydriasis;Repeat consistency posture;Facial expressions of sorrow;Moaning / weeping;Restlessness",$Q4,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Relieve pain;Physical comfort",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3"><?php echo draw_checkbox("Q6","Assess the body vital sign and note the pain-related main complaints;Understand and explain the reasons may cause pain;Reduce or exclude factors that cause/worsen pain ;Apply non-invasive pain reliefing methods such as relaxation techniques, cold or hot fomentation and massage;Assist resident to maintain a comfortable supine;Plan activity with the resident to distract pain attention;Apply anodyne/painkiller according to the medical advice;Mental support the resident to express the emotion with accompany of the family",$Q6,"multi"); ?></td>
  </tr>
