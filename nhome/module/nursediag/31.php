...
<h3>31# Nursing diagnosis -Poor glycemic control - too high</h3>
<table>
  <tr>
  ...
  <tr>
    ...
    <td colspan="3"><?php echo draw_checkbox("Q3","Hyperphagia;Fail to take Hypoglycemic agents according to schedule;Stop taking Hypoglycemic agents not according to schedule;Emotional and pressure changes;Physical discomfort;Other(s):<input type='text' name='Q3a' id='Q3a' size='30' value='".$Q3a."' />",$Q3,"multi"); ?>
    </div></td>
  </tr>
  <tr>
    <td class="title">Characteristics Identified</td>
    <td colspan="3"><?php echo draw_checkbox("Q4","Resident blood glucose level before meals: <input type='text' name='Q4a' id='Q4a' size='5' value='".$Q4a."' />mg/dl,  after meal: <input type='text' name='Q4b' id='Q4b' size='5' value='".$Q4b."' />mg/dl;Change of consciousness;Dried skin and mucous membranes;Disease affecting;Weight change;Amount of urine increased;Resident appears to be fatigue;Other(s):<input type='text' name='Q4c' id='Q4c' size='30' value='".$Q4c."' />",$Q4,"multi"); ?></td>
  </tr>  
  <tr>
    <td class="title">Care goals</td>
    <td colspan="3"><?php echo draw_checkbox("Q5","Resident speaks about the importance of proper diabetes control;Intake or inject hypoglycemic agents on schedule;Cooperate with the diet adjustment;Exercise timely;Correctly tell normal blood glucose range of diabetes ;Maintaining proper weight;Timely self-monitor the blood glucose on schedule;Other(s):<input type='text' name='Q5a' id='Q5a' size='30' value='".$Q5a."' />",$Q5,"multi"); ?></td>
  </tr>
  <tr>
    <td class="title">Nursing intervention(s)</td>
    <td colspan="3">
	<?php echo draw_checkbox("Q6","Assist resident intaking or injecting hypoglycemic agents on schedule;Good diabetes control;Adjustment diabetic diet;Arrange regular exercise daily;Reduce diabetes complications;Teach the caregivers/ care workser, residents or their families hypoglycemic agents side effects and precautions;Daily schedule monitoring the blood glucose for resident with diabetes;Teach caregivers/ care workers and resident to perform foot care daily;Hospitalize or regular clinic revisit if necessary;Other(s):<input type='text' name='Q6b' id='Q6b' size='30' value='".$Q6b."' />",$Q6,"multi"); ?>
   </td>
  </tr>
</table>
