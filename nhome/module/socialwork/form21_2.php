...
?>
<p align="right"><a href="printsocialform21_2.php?pid=<?php echo $pid; ?>&date=<?php echo @$_GET['date']; ?>" target="_blank"><img src="Images/print.png" /></a></p>
...
<table width="100%">
  ...
  <tr>
    ...
    <td colspan="7"><textarea name="Q7" id="Q7" cols="100" rows="4"><?php echo $Q7; ?></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="8">Short term goals achievement percentage:<?php echo draw_option("Q8","100%Complete;85%Complete;50%Complete;25%Complete;0%Complete","m","single",$Q8,false,1); ?><br /><textarea name="Q9" id="Q9" cols="100" rows="4"><?php echo $Q9; ?></textarea></td>
  </tr>
  <tr>
