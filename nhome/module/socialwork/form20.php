...
<h3>Pain assessment notification (Social work)</h3>
...
for ($i=0;$i<$db->num_rows();$i++) {
	...
	echo '
  <tr>
    <td align="center">'; if ($db1->num_rows()>0) { echo '<a href="index.php?mod=socialwork&func=formview&pid='.@$_GET['pid'].'&id=20_1&date='.$r2['date'].'&reply='.$r['date'].'"><img src="Images/edit_icon.png"></a>'; } echo '</td>
    ...
    <td align="center">'; if ($Q20==2) { echo "Not notify"; } else { if ($db1->num_rows()==0) { echo 'Not replied'; } else { echo 'Replied'; } } echo '</td>
    <td align="center">'.checkusername($r1['Qfiller']).'</td>
    <td align="center">'; if ($Q21==2) { echo "Not notify"; } else { if ($db2->num_rows()==0) { echo '<a href="index.php?mod=socialwork&func=formview&pid='.@$_GET['pid'].'&id=20_1&reply='.$r['date'].'">Not replied</a>'; } else { echo 'Replied'; } } echo '</td>
