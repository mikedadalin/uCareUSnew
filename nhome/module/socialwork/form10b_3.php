...
<table style="width:100%;" border="0">
  ...
  <tr>
    <td class="title_s" width="100">Social working group</td>
    <td>
    1.The work objectives:<?php echo option_result("Q24","Maintain;Alter","xs","single",$Q24,true,2); ?> <?php echo $Q24a; ?><br />
...
<table border="0" style="width:100%;">
  ...
  <tr>
    ...
    <td colspan="5">
    Previous care goal implementation and effectiveness
    <?php echo draw_checkbox("Q28","Completed, description:<input type=\"text\" name=\"Q28a\" id=\"Q28a\" value=\"".$Q28a."\" size=\"50\" >;Partially completed, reason:<input type=\"text\" name=\"Q28b\" id=\"Q28b\" value=\"".$Q28b."\" size=\"50\" >;Incomplete / not performed, reason:<input type=\"text\" name=\"Q28c\" id=\"Q28c\" value=\"".$Q28c."\" size=\"50\" >",$Q28,"single"); ?>
    </td>
  </tr>
  <tr>
    <td  class="title_s">Rehabilitation group</td>
  ...
  <tr>
    <td colspan="6" > <textarea id="Q30" name="Q30"  cols="60" rows="5"><?php echo $Q30; ?></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="title_s" width="100">Nursing group</td>
    <td colspan="5"><?php echo $Q31; ?></td>
  </tr>
  <tr>
    <td class="title_s" width="100">Social working group</td>
    <td colspan="5">
    1.The work objectives<br />
    <?php echo draw_option("Q32","Maintain;Alter","s","single",$Q32,true,2); ?> <input type="text" name="Q32a" id="Q32a" size="50" value="<?php echo $Q32a; ?>"><br />
    2. The implementation measures<br />
    <textarea id="Q33" name="Q33"  cols="60" rows="3"><?php echo $Q33; ?></textarea>
    </td>
  </tr>
  <tr>
    <td  class="title_s" width="100">Rehabilitation group</td>
    <td colspan="5"><?php echo $Q34; ?></td>
  </tr>
  <tr>
    <td class="title_s">Nursing group staff</td>
    <td width="200"><?php echo $Qfiller7==""?"":checkusername($Qfiller7); ?></td>
    <td class="title_s">Social working group staff</td>
    <td width="200"><?php echo $Qfiller8==""?checkusername($_SESSION['ncareID_lwj']):checkusername($Qfiller8); ?><input type="hidden" name="Qfiller8" id="Qfiller8" value="<?php echo $_SESSION['ncareID_lwj']; ?>" /></td>
