...
<table border="1" style="border-collapse:collapse; text-align:center;" width="1480">
  ...
  <tr height="24">
	...
	<td rowspan="'.$rowspan.'">'.formatshortdate(str_replace("/","",$r['Qstartdate'])).'</td>
    <td rowspan="'.$rowspan.'">'.formatshortdate(str_replace("/","",$r['Qenddate'])).'</td>
  ...
  ?>
  <tr height="60">
    <td colspan="3" rowspan="2" class="title"><font size="2">護理人員簽章</font></td>
    <td class="title"><font size="2">Day shift</font></td>
    <td>&nbsp;</td>
    <?php echo drawmedcal('',''); ?>
  </tr>
  <tr height="60">
