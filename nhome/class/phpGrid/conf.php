...
define('PHPGRID_DB_USERNAME', 'tnoaunimewb9aenr');     // database user name
define('PHPGRID_DB_PASSWORD', '2A28C5TLYTYFq1ZkkX1I'); // database password
define('PHPGRID_DB_NAME', 'tnoaunimewb9aenr-9999'); // database name
...
define('SERVER_ROOT', 'class/phpGrid');
define('THEME', 'start');
