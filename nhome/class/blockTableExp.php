    ...
    <td>
      <table border="0" class="a1" width="100%">
          ...
          <tr>
            ...
            <th class="title" width="200">Storehouse</th>
            <th class="title" width="180">Expire date</th>
...
?>        
        ...
        <input type="hidden" value="<?php echo $IC;?>" id="ICount<?php echo $infoOrd;?>" name="ICount<?php echo $infoOrd;?>" />
          <tr id="DelTR<?php echo $infoOrd;?>">
          	...
          	<td width="50"><input type="text" size="3" id="olddQTY<?php echo $infoOrd;?>" name="olddQTY<?php echo $infoOrd;?>" onblur="oS_AMT(<?php echo $infoOrd;?>);" value="<?php echo $OC; ?>" readonly/></td>
            ...
            <td width="180"><input type="text" size="8" id="oldeDate<?php echo $infoOrd;?>" name="oldeDate<?php echo $infoOrd;?>"  value="<?php echo $r['oldeDate']; ?>" /><script> $(function() { $( "#oldeDate<?php echo $infoOrd;?>").datetimepicker({format:'Y/m/d', timepicker: false, mask: true}); }); </script></td>          
