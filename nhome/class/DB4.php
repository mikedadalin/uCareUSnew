...
{
	var $DB_HOST;		//資料庫主機位置
	var $DB_USER;		//資料庫的使用帳號
	var $DB_PASSWORD;	//資料庫的使用密碼
	var $DB_NAME;		//資料庫名稱
	var $DB_LANGUAGE;	//資料庫使用語系
	
	var $conn;
	var $result;
	
	function DB4($argDB_HOST = '220.135.180.188', $argDB_USER = 'haititaiwanhis', $argDB_PASSWORD = 'asdf6543++++', $argDB_NAME = 'hospital', $argDB_Language = 'UTF8')
	{
